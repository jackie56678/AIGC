    ...
    <div>
      ...
      <el-form ref="imageForm" :model="imageForm" label-width="100px" style="margin-top: 20px;">
        <el-form-item label="日期">
          <el-date-picker v-model="uploadDate" type="date" placeholder="选择日期"></el-date-picker>
        </el-form-item>
        <el-form-item>
  ...
  export default {
    ...
    methods: {
      submitForm() {
        ...
        axios.post('/api/ocr/add', formData, {
          headers: {
        ...
        .then(response => {
          ...
          // Clear file list and date after successful upload
          this.fileList = [];
          this.uploadDate = '';
          this.$router.push('/ocr/list');
        })
        .catch(error => {
